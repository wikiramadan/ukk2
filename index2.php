...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($diskon > 100 || $diskon < 0) {
        echo "<script>alert('Diskon tidak valid!'); window.location='index2.php';</script>";
        exit;
    }
    if ($hargaawal === "") {
        echo "<script>alert('Silahkan masukkan harga awal'); window.location='index2.php';</script>";
    } elseif ($diskon === "") {
        echo "<script>alert('Silahkan masukkan diskon barang'); window.location='index2.php';</script>";
    } elseif (!is_numeric($hargaawal) || !is_numeric($diskon)) {
        echo "<script>alert('Harga dan diskon harus berupa angka!'); window.location='index2.php';</script>";
    } elseif ($diskon > 100) {
        echo "<script>alert('Diskon Terlalu Banyak'); window.location='index2.php';</script>";
    } elseif ($diskon < 0) {
        echo "<script>alert('Diskon tidak valid'); window.location='index2.php';</script>";
    } else {
    ...
    <div class="container">
        ...
        <div class="form-box">
            ...
            <form method="post" action="">
                ...
                <div class="row">
                    <div class="label"><label for="namabarang">Nama Barang</label></div>
                    <div class="input">
                ...
                <!-- <div class="row">
                    <div class="label"><label for="jenisbarang">Jenis Barang</label></div>
                    <div class="input">
            ...
            <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && is_numeric($hargaawal) && is_numeric($diskon) && $diskon >= 0 && $diskon <= 100): ?>
                <div class="hasil-box">
                    ...
                    <div class="hasil-item">Nama Barang: <?php echo htmlspecialchars($namabarang); ?></div>
                    <!-- <div class="hasil-item">Jenis Barang: <?php echo ucfirst(string: $jenisbarang); ?></div> -->
